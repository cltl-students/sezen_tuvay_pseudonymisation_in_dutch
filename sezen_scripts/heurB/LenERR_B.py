...
for file in os.listdir(directory):
        if file != '.DS_Store':
            ...
            with open(directory+file) as f:
                ...
                all_SPU.append(SPU)
                all_NON.append(NON)
                all_all.append(NEW_COR+INC+MIS+SPU+NON+PAR)
        ...
        df.to_csv('/Users/sezentuvay/Desktop/ALLES voor Thesis/e2e-Dutch-master/sezen_data/muc_tables/LenERR_B.tsv', index=False, sep='\t', header=header)
