...
directory2 = "/Users/sezentuvay/Desktop/ALLES_voor_Thesis/e2e-Dutch-master/sezen_data/pseudo-b/"
...
def final_alignment():
    ...
    for file in os.listdir(directory):
        ...
        df.to_csv(f'/Users/sezentuvay/Desktop/ALLES_voor_Thesis/e2e-Dutch-master/sezen_data/gold_model_combined_heuristics_b/{filename}.tsv', index=True, sep='\t', header=header)
