...
for file in os.listdir(directory):
        ...
        df.to_csv('/Users/sezentuvay/Desktop/ALLES_voor_Thesis/e2e-Dutch-master/sezen_data/muc_tables/ERR_A.tsv', index=False, sep='\t', header=header)

                #print(file, COR, PAR, INC, MIS, SPU, NON)
